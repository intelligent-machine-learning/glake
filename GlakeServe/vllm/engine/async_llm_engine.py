...
class _AsyncLLMEngine(LLMEngine):
    ...
    async def step_async(
        ...
        #slots = [u_seq.get_slot() for u_seq in self.unmap_list] 
        #res = vmmAllocator.query_unmap(slots)
        #new_unmap_list = []    
        #for i in range(len(self.unmap_list)):
        #    seq = self.unmap_list[i]
        #    if res[i]:
        #        new_unmap_list.append(seq)
        #    else:
        #        self.scheduler.free_seq(seq)
        #self.unmap_list = new_unmap_list
